...
```bash
# Init control-plane
kubeadm init --pod-network-cidr="10.244.0.0/16" --upload-certs --kubernetes-version="v1.26.0" --control-plane-endpoint="20.230.195.157" --cri-socket="unix:///run/containerd/containerd.sock" --skip-phases=addon/kube-proxy
```
